...
import { FaPlus, FaFacebookF, FaInstagram, FaTwitter, FaLinkedin } from "react-icons/fa";
            ...
            <div className="px-6 mt-3">
                ...
                <div className="space-y-4">
                    <div className="flex items-center text-gray-700">
                        ...
                        <span className="text-xs font-bold">PWANHAVEN@GMAIL.COM</span>
                    </div>
                    ...
                    <div className="flex items-start text-gray-700">
                        ...
                        <span className="text-xs font-bold">PLOT 10 ROAD 4, LEKKI COUNTY HOMES IKOTA VILLA LEKKI LAGOS.</span>
                    </div>
                    ...
                    <div className="flex items-center text-gray-700">
                        ...
                        <span className="text-xs font-bold">09124115554 <br />09060004376</span>
                    </div>
                </div>
            </div>
